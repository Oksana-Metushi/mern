      ...
      <div className="max-w-screen-2xl container mx-auto xl:px-24 px-4">
        <div className="py-[10%] flex flex-col items-center justify-center">
          <div className=" text-center px-4 space-y-7">
            <h2 className="md:text-5xl text-4xl font-bold md:leading-snug leading-snug">
              Items Added to The<span className="text-gold"> Cart</span>
            </h2>
          </div>
        </div>
...

        {
          (cart.length > 0) ? <div>
            <div className="">
              <div className="overflow-x-auto">
                <table className="table">
                  <thead className="bg-gold text-white rounded-sm">
                    <tr>
                      <th>#</th>
                      <th>Food</th>
                      <th>Item Name</th>
            ...
            <div className="flex flex-col md:flex-row justify-between items-start py-12 gap-8">
              ...
              <div className="md:w-1/2 space-y-3">
                ...
                <Link to="/process-checkout">
                  <button className="btn btn-md bg-gold text-white px-8 py-1 mt-5">
            ...
            <Link to="/menu"><button className="btn bg-gold text-white mt-3">Back to Menu</button></Link>
          </div>
        }
